...
<html lang="id">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset("FE/Login/bootstrap.min.css") }}">
    ...
    <body>
        ...
        <script src="{{ asset("FE/Login/bootstrap.bundle.min.js") }}"></script>
        <script src="{{ asset("FE/Login/jquery-3.5.1.slim.min.js") }}"></script>
