            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Form Tambah Material</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('material/') }}" method="POST">
                            @csrf

                            <input type="hidden" name="order_product_id" value="{{ $order_id }}">
                            ...
                            <div class="form-group text-right">
                                <a href="{{ url('detail-order/' . $order_id) }}" class="btn btn-secondary">Batal</a>
