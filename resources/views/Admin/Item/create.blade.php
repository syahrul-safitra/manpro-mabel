                        ...
                        <form action="{{ url('item') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="integer" class="form-control @error('harga_beli') is-invalid @enderror"
                                    id="harga_beli" name="harga_beli" placeholder="Masukkan harga beli produk"
                            ...
                            <div class="form-group">
                                ...
                                <input type="integer" class="form-control @error('harga_jual') is-invalid @enderror"
                                    id="harga_jual" name="harga_jual" placeholder="Masukkan harga jual produk"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('stok') is-invalid @enderror"
                                    id="stok" name="stok" placeholder="Masukkan jumlah stok" value="0"
                                    min="0" readonly>
                                @error('stok')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
