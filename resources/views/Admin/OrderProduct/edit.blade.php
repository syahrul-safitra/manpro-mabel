                        ...
                        <form action="{{ url('/order/' . $order->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('biaya_pembuatan') is-invalid @enderror"
                                    ...
                                    value="{{ old('biaya_pembuatan', $order->biaya_pembuatan) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-2">
                                    <img id="preview-gambar" src="{{ asset('/File/' . $order->desain) }}"
                                        alt="Preview Gambar" class="img-thumbnail" style="max-height: 200px;">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('waktu_mulai') is-invalid @enderror"
                                    ...
                                    value="{{ old('waktu_mulai', $order->waktu_mulai) }}">
                                @error('waktu_mulai')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('waktu_selesai') is-invalid @enderror"
                                    ...
                                    value="{{ old('waktu_selesai', $order->waktu_selesai) }}">
                                @error('waktu_selesai')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
